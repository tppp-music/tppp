...
var tmpBookConfig={},checkBookConfig=function(){var b=allocateUTF8(htmlConfig.bookConfig);window.key_index=Module._DeConfig_Parse(b);void 0==window.aliasConfig&&(window.aliasConfig={});tmpBookConfig.disablePrintShortcut=getConfigValue("disablePrintShortcut",!1);tmpBookConfig.chatBotButtonIconHeight=getConfigValue("chatBotButtonIconHeight",56);tmpBookConfig.chatBotButtonIcon=getConfigValue("chatBotButtonIcon","");tmpBookConfig.isAccessibilityButtonVisible=getConfigValue("isAccessibilityButtonVisible",
...
getConfigValue("autoPlayAutoStart",!1);tmpBookConfig.autoPlayDuration=getConfigValue("autoPlayDuration",3);tmpBookConfig.autoPlayLoopCount=getConfigValue("autoPlayLoopCount",1);tmpBookConfig.minZoomWidth=getConfigValue("minZoomWidth",0);tmpBookConfig.minZoomHeight=getConfigValue("minZoomHeight",0);tmpBookConfig.maxZoomWidth=getConfigValue("maxZoomWidth",0);tmpBookConfig.maxZoomHeight=getConfigValue("maxZoomHeight",0);tmpBookConfig.defaultZoomWidth=getConfigValue("defaultZoomWidth",0);tmpBookConfig.defaultZoomHeight=
...
tmpBookConfig.pageNumberCaption=getConfigValue("pageNumberCaption","");tmpBookConfig.buttonsSortXML=getConfigValue("buttonsSortXML",[]);tmpBookConfig.toolbarAlwaysShow=getConfigValue("toolbarAlwaysShow",!1);tmpBookConfig.searchbarAlwaysShowOnMobile=getConfigValue("searchbarAlwaysShowOnMobile",!1);isPhone()||isPad()||(tmpBookConfig.toolbarAlwaysShow=!0);tmpBookConfig.leftRightPnlShowOption=getConfigValue("leftRightPnlShowOption","").toLowerCase();tmpBookConfig.mobileLeftRightPnlShowOption=getConfigValue("mobileLeftRightPnlShowOption",
...
0);tmpBookConfig.textSharpening=getConfigValue("textSharpening",!0);if(_agent_.browser.firefox||_agent_.browser.opera||_agent_.browser.safari)tmpBookConfig.textSharpening=!1;tmpBookConfig.AboutDescription=tmpBookConfig.AboutDescription.replace(/\n/g,"<br/>");tmpBookConfig.AboutDescription=tmpBookConfig.AboutDescription.replace(/\r/g,"<br/>");checkBookmarkConfig();isBelowIE9()&&(tmpBookConfig.BookMarkButtonVisible=!1,tmpBookConfig.AnnotationButtonVisible=!1,tmpBookConfig.WeChatShareButtonVisible=!1);
tmpBookConfig.useTheAliCloudChart&&tmpBookConfig.backGroundImgURL&&(0<=tmpBookConfig.backGroundImgURL.indexOf("?")?tmpBookConfig.backGroundImgURL+="&x-oss-process=image/resize,h_800":tmpBookConfig.backGroundImgURL+="?x-oss-process=image/resize,h_800",window.isSupportWebp&&(tmpBookConfig.backGroundImgURL+="/format,webp"));tmpBookConfig.useTheFliphtml5Service&&tmpBookConfig.backGroundImgURL&&(tmpBookConfig.backGroundImgURL=resetFliphtml5URL(tmpBookConfig.backGroundImgURL));global.checkReportConfig&&
checkReportConfig();global.aboutReadTimesCaptions="Views";"Chinese"==UserGroups&&(global.aboutReadTimesCaptions="\u95c3\u5470\ue1f0\u5a06\u2103\u669f");tmpBookConfig.isNeat=getConfigValue("isNeat",!1);0<=window.location.hash.indexOf("isNeat")&&(tmpBookConfig.isNeat=!0);tmpBookConfig.phoneToolbarType=getConfigValue("phoneToolbarType","image").toLowerCase();tmpBookConfig.phoneIconNumber=getConfigValue("phoneIconNumber",6);tmpBookConfig.phoneIconNumber=Math.max(1,tmpBookConfig.phoneIconNumber);tmpBookConfig.showAdOnTop=
getConfigValue("showAdOnTop",!0);tmpBookConfig.bookPath=getConfigValue("bookPath",window.location.href);tmpBookConfig.bookPath=tmpBookConfig.bookPath.removeStartFrom("index.html");tmpBookConfig.bookPath=tmpBookConfig.bookPath.removeStartFrom("articles/");tmpBookConfig.bookPath=tmpBookConfig.bookPath.removeStartFrom("mobile/");tmpBookConfig.bookPath=tmpBookConfig.bookPath.removeStartFrom("?");tmpBookConfig.bookPath=tmpBookConfig.bookPath.removeStartFrom("#");"/"!=tmpBookConfig.bookPath.slice(-1)&&
...
var VERSION_NAME="6.4.9",BUILD_DATE="2025012101",BookType={normal_book:0,single_book:1,slide_book:3,singleSlide_book:6,catalog_book:7,singleCatalog_book:8},normalBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},singleBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},bookCorner={top_left:0,top_right:1,bottom_left:2,bottom_right:3},BrowserType={WEBKIT:1,OPERA:1,MOZ:2,MS:3},Direction={left:"left",right:"right",
...
"object"==typeof g&&(g=g[0]);getBlob(g).then(function(k){this.loadingTask=pdfjsLib.getDocument({url:k.url,password:k.password});this.loadingTask.promise.then(function(l){l.getPage(1).then(function(n){this.loaded=!0;this.page=n;this.renderCanvas(this.pageWidth,this.pageHeight).then(function(p){this.rendered=!0;this.callback&&this.callback(p);d(p)}.bind(this))}.bind(this))}.bind(this))}.bind(f));h.jumpToEnd()})}.bind(this))},renderCanvas:function(b,c){this.rendered=!1;return new Promise(function(d,
e){this.renderWidth=b;this.renderHeight=c;this.renderTask&&(this.renderTask.cancel(),this.renderTask=null);var f=$("<canvas><canvas/>")[0],g=f.getContext("2d"),h=window.devicePixelRatio||1,k=this.page,l=k.getViewport({scale:1});l=fitPageWidthHeight(b,c,l.width,l.height).x/l.width;l=k.getViewport({scale:l});var n=l.width,p=l.height;isPC()||(n>p?3E3<n*h&&(h=3E3/n):3E3<p*h&&(h=3E3/p));f.width=n*h;f.height=p*h;1==h?(f.style.width=f.width+"px",f.style.height=f.height+"px"):(f.style.width=n+"px",f.style.height=
p+"px");g={canvasContext:g,transform:1!==h?[h,0,0,h,0,0]:null,viewport:l};try{this.renderTask=k.render(g),this.renderTask.promise.then(function(){this.rendered=!0;d(f)}.bind(this))}catch(t){e(t)}}.bind(this))},remove:function(){},destroy:function(){this.loadingTask&&(this.loadingTask.destroy(),this.loadingTask=null);this.renderTask&&(this.renderTask.cancel(),this.renderTask=null);this.loaded=this.rendered=!1},isRepeat:function(){return this.loaded?this.pageWidth==this.renderWidth&&this.pageHeight==
...
!0:!1},hasReaderItems:function(){var b=window.readerConfig.pages[this.pageIndex-1];return b||b.inserPageLink&&b.inserPageLink.length},loading:function(){"restrict"==BookRestrict.isRestrictPage(this.pageIndex)||this.originalImageLoaded||this.removeLoad||(this.loadingImage||(this.loadingImage=$("<div class='loadingOuter'><img alt='loadingOuter' width='auto' height='auto' class='loadingImage' src='"+bookConfig.pageLoadingUrl+"'/></div>")),this.sideContent.append(this.loadingImage))},unLoading:function(b){this.hasReader()&&
...
0<global.readerConfig.pages.length&&this.hasReaderItems()?!0:!1};PageAttachmentsParser.prototype.hasReaderItems=function(){var b=window.readerConfig.pages[this.pageIndex-1];return b||b.inserPageLink&&b.inserPageLink.length};PageAttachmentsParser.prototype.isHiddenEditor=function(){return!bookConfig.isPreview||bookConfig.previewPages&&-1!==(Array.isArray(bookConfig.previewPages)&&bookConfig.previewPages.indexOf(this.pageIndex))?!1:!0};
